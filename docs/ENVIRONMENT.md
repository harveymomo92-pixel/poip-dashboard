...
| `SOURCE_FIELD` | Mapping apply only | Required for `pnpm bc:mapping-apply`. One of `machine_description`, `machine_center_no`, `prod_line_description`, `prod_line_no`, `item_no`, or `uom`. |
