...
### 5. Generate seed drafts when input is empty
...
P0.9f/P0.9g/P0.9h/P0.9i/P0.9j/P0.9k/P0.9l scoped review commands:
...
P0.9n authoritative master seed draft:
...
Use the apply dry-run only to preview what reviewed approvals would produce later. It now consumes accepted approval-intake rows when present; missing, pending, rejected, deferred, invalid, duplicate, unknown, and blocked reviewer decisions are never executable. It writes executable and blocked dry-run plans, P1.0 impact estimates, and `intake-source-summary.csv`, but it does not apply decisions and cannot unblock P1.0.
